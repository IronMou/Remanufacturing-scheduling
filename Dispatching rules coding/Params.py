...
parser.add_argument(
    "--num_mlp_layers_actor", type=int, default=2, help="No. of layers in actor MLP"
)
parser.add_argument(
    "--hidden_dim_actor", type=int, default=32, help="hidden dim of MLP in actor"
)
parser.add_argument(
...
parser.add_argument(
    "--batch_size", type=int, default=128, help="No. of envs for training"
)
parser.add_argument(
    "--num_ins", type=int, default=12800, help="No. of envs for training"
)
...
parser.add_argument(
    "--k_epochs", type=int, default=3, help="update policy for K epochs"
)
parser.add_argument(
